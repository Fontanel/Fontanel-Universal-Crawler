<div class="rsContent item story nieuwwerk header carousel post-<?php print( $vars['objects']->ID ); ?>" <?php include( dirname(__FILE__) . '/partials/carousel-colors.php' ); ?> data-id="<?php print_r( $vars['id'] ); ?>">
