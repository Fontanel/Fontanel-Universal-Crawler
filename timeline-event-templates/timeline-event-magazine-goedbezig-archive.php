<div class="item story goedbezig header post-<?php print( $vars['objects']->ID ); ?>-archive" style="background-image: url('<?php print( get_field( 'bg_pattern', $vars['objects']->ID ) ); ?>');">
